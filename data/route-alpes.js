...
const ETAPES = [
  ...
  {
    km: 206, h: "17:25", nm: "Walchensee", dest: "Zwergern, Walchensee, Kochel am See",
    swim: true, plan: "bain",
    tags: [["swim", "Baignade ★★"], ["view", "Vue ★"], ["", "18 °C"]],
    texte: "Le clou de la journée. Lac de haute montagne à 800 m, turquoise saturé, cerné de sommets. On vise la presqu'île de Zwergern, sur la rive nord-ouest.",
    guide: "<p>Le Walchensee apparaît d'un coup au sommet du col : huit cents mètres au-dessus du niveau de la mer, d'un turquoise dense qui paraît artificiel. C'est l'un des plus grands et des plus profonds lacs alpins d'Allemagne — cent quatre-vingt-dix mètres de fond — et sa couleur vient des fines particules calcaires en suspension.</p><p><strong>L'électricité.</strong> En 1924, on a construit une centrale hydroélectrique qui utilise les deux cents mètres de dénivelé entre le Walchensee et le Kochelsee. Elle fut longtemps la plus puissante d'Europe et alimente encore le réseau ferroviaire bavarois. Les conduites forcées descendent la montagne juste à côté de la route que vous venez de monter.</p><p><strong>L'or.</strong> En avril 1945, dans les derniers jours du régime, des convois de la Reichsbank ont dispersé les réserves d'or et de devises dans les Alpes bavaroises. Une partie a été enterrée dans la région, et l'on a longtemps affirmé que des caisses avaient été immergées dans ce lac. Des plongeurs, des chercheurs de trésor et quelques expéditions officielles s'y sont succédé pendant des décennies ; on a effectivement remonté des billets, jamais l'or. L'affaire alimente encore les conversations locales.</p><p><strong>Où se baigner, précisément.</strong> Vous débouchez du Kesselberg à Urfeld, à l'angle nord-est : ne vous y arrêtez pas, c'est le point le plus fréquenté et la rive y est caillouteuse. Continuez sur la B11 le long de la rive nord-ouest jusqu'à la <strong>presqu'île de Zwergern</strong>, à cinq ou six kilomètres — c'est sur la route de Wallgau, donc aucun détour. Pelouse pour poser les affaires, entrée dans l'eau très progressive, et une position un peu abritée du vent thermique qui souffle l'après-midi. C'est le meilleur compromis du lac avec des enfants. L'anse de sable près d'Einsiedl, deux kilomètres avant, est plus photogénique mais moins confortable.</p><p><strong>Le stationnement.</strong> Les aires payantes s'échelonnent le long de la B11 au-dessus des criques ; on se gare sur le bas-côté aménagé et on descend par un sentier d'une à deux minutes. Prévoyez des pièces, ces horodateurs ne prennent pas la carte. Pas de toilettes ni de buvette aux accès libres — il y a un Gasthof à Einsiedl. Des chaussures d'eau sont utiles, l'entrée alterne sable et galets.</p><p><strong>L'eau est à dix-huit degrés.</strong> C'est court, c'est vif, et c'est exactement le genre de bain dont on se souvient vingt ans plus tard. Le lac est aussi un spot de planche à voile réputé, grâce à ce vent thermique qui se lève chaque après-midi — cherchez une anse plutôt qu'un bord exposé, ça change tout au moment de sortir de l'eau.</p><p><strong>La lumière.</strong> Les crêtes coupent le soleil bien avant le coucher : en août, la rive nord bascule progressivement à l'ombre à partir de 18 h 30 environ. À 17 h 25 vous avez encore l'eau en pleine lumière, mais ne traînez pas trop — c'est plus agréable au soleil, et l'eau est à dix-huit degrés.</p>"
  },
  {
...
const SEGMENTS = [
  ...
  },
  {
    ...
    waypoints: [
      ...
      "Zwergern, Walchensee, Kochel am See",
      "Barmsee, Krün"
    ]
  }
];
