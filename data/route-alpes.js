...
const ETAPES = [
  ...
  },
  {
    ...
    tags: [["", "Hameau"], ["stop", "Spot pique-nique"]],
    ...
    guide: "<p>Quelques centaines d'habitants, une église baroque seule au milieu des prés, et le silence. Sachrang est le bout du Priental, à un kilomètre de la frontière autrichienne.</p><p>Le village entretient la mémoire du « Müllner Peter », un meunier du XIX<sup>e</sup> siècle qui était aussi compositeur, guérisseur et herboriste — une de ces figures de sagesse rurale dont la Bavière raffole. Son moulin se visite.</p><p><strong>Pour un pique-nique</strong>, c'est un bon plan B : des prés, de l'ombre, aucune foule, et des tables près de l'église. Moins spectaculaire que le Sudelfeld plus loin, mais quarante minutes plus tôt sur la route si les estomacs ne tiennent pas.</p>"
  },
  {
  ...
  },
  {
    ...
    tags: [["view", "Cascade"], ["p", "2 €"], ["stop", "Spot ombragé"]],
    texte: "Une cascade dans une gorge étroite, à cent mètres de la route, par un escalier. Dix minutes. Frais et ombragé.",
    guide: "<p>La remontée vers le Sudelfeld est le premier vrai morceau de bravoure routier de la journée : des lacets serrés dans la forêt, et cette gorge où gronde une cascade à cent mètres de la chaussée.</p><p><strong>Le nom.</strong> Le <em>Tatzelwurm</em>, le « ver à pattes », est une créature du folklore alpin — une sorte de lézard-dragon trapu que les bergers juraient avoir vu jusqu'au XIX<sup>e</sup> siècle. Les récits sont assez nombreux et concordants pour que des naturalistes s'y soient sérieusement intéressés ; on n'a jamais rien trouvé. Le nom est resté sur la cascade, sur l'auberge et sur la route.</p><p><strong>Si vous cherchez de l'ombre</strong> pour les sandwiches, c'est ici : la gorge est fraîche, il y a des bancs près de l'auberge, et le bruit de l'eau occupe les enfants. C'est l'alternative au Sudelfeld si le soleil tape trop fort sur le plateau.</p>"
  },
  {
